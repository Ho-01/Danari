...
public class Club {
    ...
    private String department; // 어느 분과에 속하는 동아리인지 = 교양분과, 봉사분과, 학술분과, 공연예술분과, 문예창작분과, 종교분과, 체육분과
    ...
    @Builder
    public Club(String clubName, String roomNumber, String department, String description) {
