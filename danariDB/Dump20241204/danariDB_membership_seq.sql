...
--
-- Table structure for table `membership_seq`
--
...
--
-- Dumping data for table `membership_seq`
--

LOCK TABLES `membership_seq` WRITE;
/*!40000 ALTER TABLE `membership_seq` DISABLE KEYS */;
INSERT INTO `membership_seq` VALUES (101);
/*!40000 ALTER TABLE `membership_seq` ENABLE KEYS */;
UNLOCK TABLES;
